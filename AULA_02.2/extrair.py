...
def extrair_metadados(caminho_md):
    """Lê um arquivo Markdown e extrai título, autores, ano, métricas e limitações em formato JSON."""
        ...
        messages=[
            {
                "role": "system",
                "content": (
                    "Extraia o título, autores, ano, métricas/resultados principais e limitações do artigo. "
                    "Caso o texto não mencione métricas ou limitações explicitamente, insira listas vazias ou descrições breves de ausência. "
